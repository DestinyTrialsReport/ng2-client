...
export const routes: Routes = [
  ...
  // { path: 'weapons/:type/:week',  component: LeaderboardsComponent, data: { board: 'weapons' } },
  // { path: 'players/:type/:week',  component: LeaderboardsComponent, data: { board: 'players' } },
  // { path: 'medals/:type/:week',   component: LeaderboardsComponent, data: { board: 'medals' } },
  // { path: 'ps/:gamertag/:week',   component: LeaderboardsComponent, data: { board: 'searched', platform: 'ps' } },
  // { path: 'xbox/:gamertag/:week', component: LeaderboardsComponent, data: { board: 'searched', platform: 'xbox' } },
